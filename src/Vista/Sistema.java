...
public final class Sistema extends javax.swing.JFrame {
    ...
    public void ListarCliente() {
        ...
        for (Cliente element : ListarCl) {
            ob[0] = element.getId();
            ob[1] = element.getDni();
            ob[2] = element.getNombre();
            ob[3] = element.getTelefono();
            ob[4] = element.getDireccion();
            modelo.addRow(ob);
        }
    ...
    public void ListarProveedor() {
        ...
        for (Proveedor element : ListarPr) {
            ob[0] = element.getId();
            ob[1] = element.getRuc();
            ob[2] = element.getNombre();
            ob[3] = element.getTelefono();
    ...
    public void ListarUsuarios() {
        ...
        for (Modelo.login element : Listar) {
            ob[0] = element.getId();
            ob[1] = element.getNombre();
            ob[2] = element.getCorreo();
            ob[3] = element.getRol();
            modelo.addRow(ob);
        }
    ...
    public void ListarProductos() {
        ...
        Object[] ob = new Object[6];
        for (Productos element : ListarPro) {
            ob[0] = element.getId();
            ob[1] = element.getCodigo();
            ob[2] = element.getNombre();
            ob[3] = element.getProveedorPro();
            ob[4] = element.getStock();
            ob[5] = element.getPrecio();
            modelo.addRow(ob);
        }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new ImageIcon(Sistema.class.getResource("/Img/usuario.png")));
        jLabel2 = new javax.swing.JLabel();
        jLabel2.setIcon(new ImageIcon(Sistema.class.getResource("/Img/encabezado.png")));
        ...
        TableUsuarios.addMouseListener(new MouseAdapter() {
        	...
        	public void mouseClicked(MouseEvent e) {
        		...
        		idusuario=Integer.parseInt(TableUsuarios.getValueAt(fila, 0).toString());
        ...
        jLabel1.setIcon(new ImageIcon(Sistema.class.getResource("/Img/cesta-de-mano.png"))); // NOI18N

        btnNuevaVenta.setBackground(new Color(192, 192, 192));
        btnNuevaVenta.setForeground(new Color(0, 0, 0));
        btnNuevaVenta.setIcon(new ImageIcon(Sistema.class.getResource("/Img/bolsa.png"))); // NOI18N
        ...
        btnClientes.setIcon(new ImageIcon(Sistema.class.getResource("/Img/cliente.png"))); // NOI18N
        ...
        btnProveedor.setBackground(new Color(192, 192, 192));
        btnProveedor.setForeground(new Color(0, 0, 0));
        btnProveedor.setIcon(new ImageIcon(Sistema.class.getResource("/Img/mensajero.png"))); // NOI18N
        ...
        btnProductos.setBackground(new Color(192, 192, 192));
        btnProductos.setForeground(new Color(0, 0, 0));
        btnProductos.setIcon(new ImageIcon(Sistema.class.getResource("/Img/caja.png"))); // NOI18N
        ...
        btnVentas.setIcon(new ImageIcon(Sistema.class.getResource("/Img/cesta.png"))); // NOI18N
        ...
        btnConfig.setBackground(new Color(192, 192, 192));
        btnConfig.setForeground(new Color(0, 0, 0));
        btnConfig.setIcon(new ImageIcon(Sistema.class.getResource("/Img/ajustes.png"))); // NOI18N
        ...
        LabelVendedor.setText("Nombre del vendedor");
       ...
       jButton1.addActionListener(new java.awt.event.ActionListener() {
        ...
        btnSalir.setIcon(new ImageIcon(Sistema.class.getResource("/Img/cerrar-sesion.png")));
        	...
        	gl_jPanel1.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_jPanel1.createSequentialGroup()
        			.addGroup(gl_jPanel1.createParallelGroup(Alignment.LEADING)
        				...
        				.addComponent(LabelVendedor, GroupLayout.PREFERRED_SIZE, 190, GroupLayout.PREFERRED_SIZE)
        				.addGroup(gl_jPanel1.createSequentialGroup()
        					.addComponent(btnNuevaVenta, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(tipo))
        				.addComponent(btnClientes, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
        				.addComponent(btnProveedor, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
        				.addComponent(btnProductos, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
        				.addComponent(btnVentas, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
        				.addComponent(btnConfig, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
        ...
        gl_jPanel1.setVerticalGroup(
        	gl_jPanel1.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_jPanel1.createSequentialGroup()
        			...
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(btnProveedor, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(btnProductos, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(btnVentas, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(btnConfig, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        ...
        gl_jPanel1.linkSize(SwingConstants.VERTICAL, new Component[] {jButton1, btnSalir});
        ...
        btnEliminarventa.setIcon(new ImageIcon(Sistema.class.getResource("/Img/cancelar.png"))); // NOI18N
        ...
        btnGenerarVenta.setIcon(new ImageIcon(Sistema.class.getResource("/Img/impresion.png"))); // NOI18N
        ...
        btnGraficar.setIcon(new ImageIcon(Sistema.class.getResource("/Img/grafico-circular.png"))); // NOI18N
        ...
        btnGuardarCliente.setIcon(new ImageIcon(Sistema.class.getResource("/Img/guardar-el-archivo.png"))); // NOI18N
        ...
        btnEditarCliente.setIcon(new ImageIcon(Sistema.class.getResource("/Img/actualizar.png"))); // NOI18N
        ...
        btnEliminarCliente.setIcon(new ImageIcon(Sistema.class.getResource("/Img/eliminar-simbolo.png"))); // NOI18N
        ...
        btnNuevoCliente.setIcon(new ImageIcon(Sistema.class.getResource("/Img/agregar-simbolo.png"))); // NOI18N
        		...
        		.addGroup(jPanel9Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel9Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel9Layout.createSequentialGroup()
        					...
        					.addGap(43)
        					.addComponent(txtDniCliente, GroupLayout.PREFERRED_SIZE, 150, GroupLayout.PREFERRED_SIZE))
        				.addGroup(jPanel9Layout.createSequentialGroup()
        					.addComponent(jLabel13)
        					.addGap(46)
        					.addComponent(txtNombreCliente, GroupLayout.PREFERRED_SIZE, 148, GroupLayout.PREFERRED_SIZE))
        				.addGroup(jPanel9Layout.createSequentialGroup()
        					.addComponent(jLabel14)
        					.addGap(40)
        					.addComponent(txtTelefonoCliente, GroupLayout.PREFERRED_SIZE, 148, GroupLayout.PREFERRED_SIZE))
        				.addGroup(jPanel9Layout.createSequentialGroup()
        					.addComponent(jLabel15)
        					.addGap(38)
        					.addComponent(txtDirecionCliente, GroupLayout.PREFERRED_SIZE, 148, GroupLayout.PREFERRED_SIZE))
        				.addGroup(jPanel9Layout.createSequentialGroup()
        					.addGap(22)
        					.addComponent(txtIdCliente, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE))
        				.addGroup(jPanel9Layout.createSequentialGroup()
        					.addGap(55)
        					.addGroup(jPanel9Layout.createParallelGroup(Alignment.LEADING)
        		...
        		.addGroup(jPanel9Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel9Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel9Layout.createSequentialGroup()
        					.addGap(4)
        					.addComponent(jLabel12))
        				.addComponent(txtDniCliente, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
        			.addGap(10)
        			.addGroup(jPanel9Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel9Layout.createSequentialGroup()
        					.addGap(4)
        			...
        			.addGroup(jPanel9Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel9Layout.createSequentialGroup()
        					.addGap(4)
        					.addComponent(jLabel14))
        				.addComponent(txtTelefonoCliente, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
        			.addGap(10)
        			.addGroup(jPanel9Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel9Layout.createSequentialGroup()
        					.addGap(4)
        					.addComponent(jLabel15))
        				.addComponent(txtDirecionCliente, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
        			...
        			.addGroup(jPanel9Layout.createParallelGroup(Alignment.TRAILING)
        				...
        				.addGroup(jPanel9Layout.createSequentialGroup()
        					...
        					.addPreferredGap(ComponentPlacement.RELATED)))
        			.addGroup(jPanel9Layout.createParallelGroup(Alignment.LEADING)
        				.addComponent(btnEliminarCliente, GroupLayout.PREFERRED_SIZE, 33, GroupLayout.PREFERRED_SIZE)
        				.addComponent(btnNuevoCliente, GroupLayout.PREFERRED_SIZE, 33, GroupLayout.PREFERRED_SIZE))
        			.addGap(21))
        );
        ...
        jPanel10.setBackground(new Color(192, 192, 192));
        ...
        btnguardarProveedor.setIcon(new ImageIcon(Sistema.class.getResource("/Img/guardar-el-archivo.png"))); // NOI18N
        ...
        btnEditarProveedor.setIcon(new ImageIcon(Sistema.class.getResource("/Img/actualizar.png"))); // NOI18N
        ...
        btnNuevoProveedor.setIcon(new ImageIcon(Sistema.class.getResource("/Img/agregar-simbolo.png"))); // NOI18N
        ...
        btnEliminarProveedor.setIcon(new ImageIcon(Sistema.class.getResource("/Img/eliminar-simbolo.png"))); // NOI18N
        ...
        jPanel11.setBackground(new Color(192, 192, 192));
        ...
        btnGuardarpro.setIcon(new ImageIcon(Sistema.class.getResource("/Img/guardar-el-archivo.png"))); // NOI18N
        ...
        btnEditarpro.setIcon(new ImageIcon(Sistema.class.getResource("/Img/actualizar.png"))); // NOI18N
        ...
        btnEliminarPro.setIcon(new ImageIcon(Sistema.class.getResource("/Img/eliminar-simbolo.png"))); // NOI18N
        ...
        btnNuevoPro.setIcon(new ImageIcon(Sistema.class.getResource("/Img/agregar-simbolo.png"))); // NOI18N
        ...
        JButton btnImagenPro = new JButton("");
        btnImagenPro.setIcon(new ImageIcon(Sistema.class.getResource("/Img/imagen.png")));
        btnImagenPro.addActionListener(new ActionListener() {
        	@Override
			public void actionPerformed(ActionEvent e) {
        		JFileChooser file = new JFileChooser();
        		file.showOpenDialog(btnImagenPro);
        		File archivo=file.getSelectedFile();
        		if(archivo!=null) {
        			textImagenPro.setText(archivo.getPath());
        		}
        	}
        });

        textImagenPro = new JTextField();
        textImagenPro.setEditable(false);
        textImagenPro.setColumns(10);
        				...
        				.addGroup(jPanel11Layout.createSequentialGroup()
        					...
        					.addGroup(jPanel11Layout.createParallelGroup(Alignment.LEADING)
        						.addGroup(jPanel11Layout.createSequentialGroup()
        							...
        							.addGap(38)
        							.addComponent(txtCodigoPro, GroupLayout.PREFERRED_SIZE, 119, GroupLayout.PREFERRED_SIZE))
        						.addGroup(jPanel11Layout.createSequentialGroup()
        							.addComponent(jLabel23)
        							.addGap(12)
        							.addComponent(txtDesPro, GroupLayout.PREFERRED_SIZE, 146, GroupLayout.PREFERRED_SIZE))
        						.addGroup(jPanel11Layout.createSequentialGroup()
        							.addComponent(jLabel24)
        							.addGap(29)
        							.addComponent(txtCantPro, GroupLayout.PREFERRED_SIZE, 109, GroupLayout.PREFERRED_SIZE))
        						.addGroup(jPanel11Layout.createSequentialGroup()
        							.addComponent(jLabel25)
        							.addGap(47)
        							.addComponent(txtPrecioPro, GroupLayout.PREFERRED_SIZE, 109, GroupLayout.PREFERRED_SIZE))
        						.addGroup(jPanel11Layout.createSequentialGroup()
        							.addComponent(jLabel26)
        							.addGap(21)
        							.addComponent(cbxProveedorPro, GroupLayout.PREFERRED_SIZE, 143, GroupLayout.PREFERRED_SIZE))
        						.addGroup(jPanel11Layout.createSequentialGroup()
        							.addComponent(btnImagenPro)
        							.addPreferredGap(ComponentPlacement.UNRELATED)
        							.addComponent(textImagenPro, GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE)
        							.addContainerGap())))
        				.addGroup(jPanel11Layout.createSequentialGroup()
        		...
        		.addGroup(jPanel11Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel11Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel11Layout.createSequentialGroup()
        					.addGap(4)
        					.addComponent(jLabel22))
        				.addComponent(txtCodigoPro, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
        			.addGap(12)
        			.addGroup(jPanel11Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel11Layout.createSequentialGroup()
        					.addGap(4)
        					.addComponent(jLabel23))
        				.addComponent(txtDesPro, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
        			.addGap(14)
        			.addGroup(jPanel11Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel11Layout.createSequentialGroup()
        					.addGap(4)
        					.addComponent(jLabel24))
        				.addComponent(txtCantPro, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
        			.addGap(14)
        			.addGroup(jPanel11Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel11Layout.createSequentialGroup()
        					.addGap(4)
        					.addComponent(jLabel25))
        				.addComponent(txtPrecioPro, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
        			.addGap(16)
        			.addGroup(jPanel11Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel11Layout.createSequentialGroup()
        					.addGap(4)
        					.addComponent(jLabel26))
        				.addComponent(cbxProveedorPro, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
        			.addGap(18)
        			.addGroup(jPanel11Layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(btnImagenPro)
        				.addComponent(textImagenPro, GroupLayout.PREFERRED_SIZE, 28, GroupLayout.PREFERRED_SIZE))
        			.addGap(10)
        			.addGroup(jPanel11Layout.createParallelGroup(Alignment.LEADING)
        				.addComponent(btnGuardarpro, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
        				.addComponent(btnEditarpro)
        				.addComponent(btnEliminarPro, GroupLayout.PREFERRED_SIZE, 33, GroupLayout.PREFERRED_SIZE)
        				.addComponent(btnNuevoPro))
        			.addGap(23))
        );
        ...
        btnPdfVentas.setIcon(new ImageIcon(Sistema.class.getResource("/Img/descargar-pdf.png"))); // NOI18N
        ...
        btnActualizarConfig.setIcon(new ImageIcon(Sistema.class.getResource("/Img/actualizar.png"))); // NOI18N
        ...
        jPanel13.setBackground(new Color(112, 112, 112));

        jLabel33.setIcon(new ImageIcon(Sistema.class.getResource("/Img/usuario-e.png"))); // NOI18N
        ...
        cbxRol.setModel(new DefaultComboBoxModel(new String[] {"Administrador", "Asistente", "Cliente"}));

        JButton btnElimirarUsuario = new JButton("Eliminar");
        btnElimirarUsuario.setBackground(new Color(192, 192, 192));
        btnElimirarUsuario.setForeground(new Color(0, 0, 0));
        btnElimirarUsuario.addActionListener(new ActionListener() {
        	@Override
			public void actionPerformed(ActionEvent e) {
        		if(!"".equals(txtCorreo.getText())) {
        			int pregunta=JOptionPane.showConfirmDialog(null, "¿Está segurao de eliminar al usuario?");
        			if(pregunta==0) {
        				 String correo = txtCorreo.getText();
        		            login.Eliminar(correo);
        ...
        btnActualizarUsuario.setBackground(new Color(192, 192, 192));
        btnActualizarUsuario.setForeground(new Color(0, 0, 0));
        ...
        btnActualizarUsuario.addActionListener(new ActionListener() {
        	...
        	@Override
			public void actionPerformed(ActionEvent e) {
        		if(!"".equals(txtCorreo.getText())||!"".equals(txtNombre.getText())||!"".equals(String.valueOf(txtPass.getPassword()))) {
        			int pregunta=JOptionPane.showConfirmDialog(null, "¿Está segurao de actualizar al usuario?");
        			if(pregunta==0) {
	        				String correo = txtCorreo.getText();
        				...
        				.addGroup(jPanel13Layout.createSequentialGroup()
        					.addGroup(jPanel13Layout.createParallelGroup(Alignment.LEADING)
        						.addGroup(jPanel13Layout.createSequentialGroup()
        							...
        							.addComponent(btnElimirarUsuario, GroupLayout.PREFERRED_SIZE, 82, GroupLayout.PREFERRED_SIZE))
        						.addComponent(jLabel36)
        						.addComponent(jLabel35)
        						.addComponent(jLabel34)
        						.addComponent(txtCorreo, GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE)
        						.addComponent(txtPass, 226, 226, 226)
        						.addComponent(jLabel37)
        						.addComponent(txtNombre, 226, 226, 226)
        						.addComponent(cbxRol, 0, 260, Short.MAX_VALUE))
        					.addGap(24))
        				.addGroup(jPanel13Layout.createSequentialGroup()
        ...
        jPanel13Layout.setVerticalGroup(
        	jPanel13Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanel13Layout.createSequentialGroup()
        			...
        			.addComponent(jLabel37)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(cbxRol, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
        			...
        			.addGroup(jPanel13Layout.createParallelGroup(Alignment.BASELINE)
        				...
        				.addComponent(btnElimirarUsuario, GroupLayout.PREFERRED_SIZE, 32, GroupLayout.PREFERRED_SIZE)
        				.addComponent(btnActualizarUsuario, GroupLayout.PREFERRED_SIZE, 28, GroupLayout.PREFERRED_SIZE))
        			.addContainerGap())
        );
    ...
    private void btnEditarproActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarproActionPerformed
        ...
        if ("".equals(txtIdproducto.getText())) {
            ...
            if (!"".equals(txtCodigoPro.getText()) || !"".equals(txtDesPro.getText()) || !"".equals(txtCantPro.getText()) || !"".equals(txtPrecioPro.getText())) {
                ...
                pro.setImg(textImagenPro.getText());
    ...
    private void TableProductoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableProductoMouseClicked
        ...
        textImagenPro.setText(pro.getImg());
    ...
    private JTextField textImagenPro;
